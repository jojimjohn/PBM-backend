...
const getUserPermissions = async (roleOrRoleId, companyId, db = null) => {
  ...
  const rolePermissions = {
    'SUPER_ADMIN': [
      // Customer Management
      'VIEW_CUSTOMERS', 'CREATE_CUSTOMERS', 'EDIT_CUSTOMERS', 'DELETE_CUSTOMERS', 'MANAGE_CUSTOMERS', 'VIEW_CUSTOMER_TYPES',
      // Supplier Management
      'VIEW_SUPPLIERS', 'CREATE_SUPPLIERS', 'EDIT_SUPPLIERS', 'DELETE_SUPPLIERS', 'MANAGE_SUPPLIERS', 'VIEW_SUPPLIER_TYPES',
      'MANAGE_VENDORS', 'VIEW_VENDORS',
      'VIEW_SUPPLIER_LOCATIONS', 'CREATE_SUPPLIER_LOCATIONS', 'EDIT_SUPPLIER_LOCATIONS', 'DELETE_SUPPLIER_LOCATIONS',
      'VIEW_SUPPLIER_CONTRACTS',
      // Inventory Management
      'VIEW_INVENTORY', 'UPDATE_INVENTORY', 'MANAGE_INVENTORY', 'UPDATE_STOCK',
      'VIEW_MATERIAL_COMPOSITIONS', 'CREATE_MATERIAL_COMPOSITIONS', 'EDIT_MATERIAL_COMPOSITIONS', 'DELETE_MATERIAL_COMPOSITIONS',
      'VIEW_INVENTORY_BATCHES', 'MANAGE_INVENTORY_BATCHES',
      // Sales Management
      'VIEW_SALES', 'CREATE_SALES', 'PROCESS_SALES', 'EDIT_SALES', 'DELETE_SALES', 'APPROVE_SALES',
      // Purchase Management
      'VIEW_PURCHASE', 'VIEW_PURCHASES', 'CREATE_PURCHASE', 'CREATE_PURCHASES', 'APPROVE_PURCHASE', 'APPROVE_PURCHASES',
      'EDIT_PURCHASE', 'DELETE_PURCHASE',
      'CREATE_PURCHASE_ORDER', 'VIEW_PURCHASE_ORDER', 'EDIT_PURCHASE_ORDER', 'DELETE_PURCHASE_ORDER', 'APPROVE_PURCHASE_ORDER',
      // Purchase Order Expenses (All permissions)
      'VIEW_PO_EXPENSES_ALL', 'VIEW_PO_EXPENSES_OWN', 'CREATE_PO_EXPENSES',
      'EDIT_PO_EXPENSES_ALL', 'EDIT_PO_EXPENSES_OWN',
      'DELETE_PO_EXPENSES_ALL', 'DELETE_PO_EXPENSES_OWN',
      // Purchase Order Amendments (All permissions)
      'VIEW_AMENDMENTS_ALL', 'VIEW_AMENDMENTS_OWN', 'CREATE_AMENDMENTS',
      'EDIT_AMENDMENTS_ALL', 'EDIT_AMENDMENTS_OWN', 'APPROVE_AMENDMENTS',
      // Invoices
      'CREATE_INVOICES', 'VIEW_INVOICES', 'EDIT_INVOICES',
      // Contracts
      'VIEW_CONTRACTS', 'CREATE_CONTRACTS', 'EDIT_CONTRACTS', 'MANAGE_CONTRACTS', 'APPROVE_CONTRACTS',
      'VIEW_CONTRACT_LOCATIONS', 'CREATE_CONTRACT_LOCATIONS', 'EDIT_CONTRACT_LOCATIONS',
      'VIEW_CONTRACT_LOCATION_RATES', 'MANAGE_CONTRACT_LOCATION_RATES',
      // Wastage
      'VIEW_WASTAGE', 'CREATE_WASTAGE', 'EDIT_WASTAGE', 'DELETE_WASTAGE', 'APPROVE_WASTAGE',
      // Collections
      'VIEW_COLLECTIONS', 'CREATE_COLLECTIONS', 'EDIT_COLLECTIONS', 'DELETE_COLLECTIONS', 'APPROVE_COLLECTIONS',
      ...
      'VIEW_FINANCIALS', 'MANAGE_EXPENSES', 'APPROVE_EXPENSES', 'VIEW_PROFIT_LOSS',
      'VIEW_EXPENSES', 'MANAGE_EXPENSE_CATEGORIES', 'VIEW_EXPENSE_CATEGORIES',
      'VIEW_BANK_ACCOUNTS', 'CREATE_BANK_ACCOUNTS', 'EDIT_BANK_ACCOUNTS', 'DELETE_BANK_ACCOUNTS',
      // Reports
      'VIEW_REPORTS', 'EXPORT_REPORTS', 'CREATE_CUSTOM_REPORTS',
      // System Settings
      'VIEW_SETTINGS', 'EDIT_SETTINGS', 'MANAGE_SETTINGS', 'VIEW_BRANCHES',
      'MANAGE_BACKUPS', 'VIEW_DASHBOARD',
      // User Management
      'MANAGE_USERS', 'VIEW_USERS', 'ASSIGN_ROLES', 'MANAGE_ROLES', 'VIEW_ROLES',
      'VIEW_AUDIT_LOGS',
      // Company Management
    ...
    'MANAGER': [
      // Customer Management
      'VIEW_CUSTOMERS', 'CREATE_CUSTOMERS', 'EDIT_CUSTOMERS', 'MANAGE_CUSTOMERS', 'VIEW_CUSTOMER_TYPES',
      // Supplier Management
      'VIEW_SUPPLIERS', 'CREATE_SUPPLIERS', 'EDIT_SUPPLIERS', 'MANAGE_SUPPLIERS', 'VIEW_SUPPLIER_TYPES',
      'MANAGE_VENDORS', 'VIEW_VENDORS',
      'VIEW_SUPPLIER_LOCATIONS', 'CREATE_SUPPLIER_LOCATIONS', 'EDIT_SUPPLIER_LOCATIONS',
      'VIEW_SUPPLIER_CONTRACTS',
      // Inventory Management
      'VIEW_INVENTORY', 'UPDATE_INVENTORY', 'UPDATE_STOCK', 'MANAGE_INVENTORY',
      'VIEW_MATERIAL_COMPOSITIONS', 'CREATE_MATERIAL_COMPOSITIONS', 'EDIT_MATERIAL_COMPOSITIONS',
      'VIEW_INVENTORY_BATCHES', 'MANAGE_INVENTORY_BATCHES',
      // Sales Management
      ...
      // Purchase Order Expenses (_ALL permissions for approval authority)
      'VIEW_PO_EXPENSES_ALL', 'CREATE_PO_EXPENSES',
      'EDIT_PO_EXPENSES_ALL', 'EDIT_PO_EXPENSES_OWN',
      'DELETE_PO_EXPENSES_ALL',
      // Purchase Order Amendments (_ALL permissions for approval authority)
      'VIEW_AMENDMENTS_ALL', 'CREATE_AMENDMENTS',
      'EDIT_AMENDMENTS_ALL', 'EDIT_AMENDMENTS_OWN', 'APPROVE_AMENDMENTS',
      // Invoices
      'CREATE_INVOICES', 'VIEW_INVOICES', 'EDIT_INVOICES',
      // Contracts
      ...
      // Financial Management
      'VIEW_FINANCIALS', 'MANAGE_EXPENSES', 'APPROVE_EXPENSES', 'VIEW_PROFIT_LOSS',
      'VIEW_EXPENSES', 'VIEW_EXPENSE_CATEGORIES',
      'VIEW_BANK_ACCOUNTS',
      // Reports
    ...
    'SALES_STAFF': [
      ...
      'VIEW_SUPPLIERS', 'VIEW_SUPPLIER_TYPES', 'VIEW_SUPPLIER_LOCATIONS',
      // Inventory (view only)
      'VIEW_INVENTORY', 'VIEW_MATERIAL_COMPOSITIONS', 'VIEW_INVENTORY_BATCHES',
      // Sales Management
      'VIEW_SALES', 'CREATE_SALES', 'EDIT_SALES',
      'CREATE_INVOICES', 'VIEW_INVOICES', 'EDIT_INVOICES',
      // Contracts (view only)
      'VIEW_CONTRACTS', 'VIEW_CONTRACT_LOCATIONS', 'VIEW_CONTRACT_LOCATION_RATES',
      // Wastage (view only)
      'VIEW_WASTAGE',
      // Petty Cash - can create expenses and view own
      'VIEW_PETTY_CASH', 'CREATE_EXPENSE',
      // Financial (view only)
      'VIEW_FINANCIALS', 'VIEW_EXPENSES', 'VIEW_EXPENSE_CATEGORIES',
      // Reports (view only)
      'VIEW_REPORTS',
      // System (view only)
      'VIEW_SETTINGS', 'VIEW_BRANCHES', 'VIEW_DASHBOARD',
    ...
    'PURCHASE_STAFF': [
      ...
      // Purchase Order Expenses (_OWN permissions - can manage own expenses only)
      'VIEW_PO_EXPENSES_OWN', 'CREATE_PO_EXPENSES',
      'EDIT_PO_EXPENSES_OWN', 'DELETE_PO_EXPENSES_OWN',
      // Purchase Order Amendments (_OWN permissions - can manage own amendments only)
      'VIEW_AMENDMENTS_OWN', 'CREATE_AMENDMENTS',
      'EDIT_AMENDMENTS_OWN',
      // Contracts (view only)
      'VIEW_CONTRACTS', 'VIEW_CONTRACT_LOCATIONS', 'VIEW_CONTRACT_LOCATION_RATES',
      // Wastage Management
      ...
      // Petty Cash - can create expenses
      'VIEW_PETTY_CASH', 'CREATE_EXPENSE',
      // Financial (view only)
      'VIEW_FINANCIALS', 'VIEW_EXPENSES', 'VIEW_EXPENSE_CATEGORIES',
      // Reports (view only)
    ...
    'ACCOUNTS_STAFF': [
      ...
      'VIEW_CUSTOMERS', 'VIEW_CUSTOMER_TYPES',
      'VIEW_SUPPLIERS', 'VIEW_SUPPLIER_TYPES', 'VIEW_SUPPLIER_LOCATIONS',
      // Inventory (view only)
      'VIEW_INVENTORY', 'VIEW_MATERIAL_COMPOSITIONS', 'VIEW_INVENTORY_BATCHES',
      ...
      'VIEW_PURCHASE_ORDER',
      // Purchase Order Expenses (_ALL viewing for financial oversight)
      'VIEW_PO_EXPENSES_ALL',
      // Purchase Order Amendments (_ALL viewing for financial oversight)
      'VIEW_AMENDMENTS_ALL',
      // Invoices (edit for accounting corrections)
      'VIEW_INVOICES', 'EDIT_INVOICES',
      // Contracts (view only)
      'VIEW_CONTRACTS', 'VIEW_CONTRACT_LOCATIONS', 'VIEW_CONTRACT_LOCATION_RATES',
      // Wastage (view only)
      'VIEW_WASTAGE',
      // Petty Cash Management (full access for accounting)
      'VIEW_PETTY_CASH', 'MANAGE_PETTY_CASH',
      'VIEW_EXPENSE_REPORTS', 'CREATE_EXPENSE',
      // Financial Management (full access for accounting)
